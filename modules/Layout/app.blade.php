...
<head>
    ...
    @stack('css')
    {{--Custom Style--}}
    <link rel="stylesheet" href="{{asset('memnon/css/swiper-bundle.min.css')}}">
    <link rel="stylesheet" href="{{asset('memnon/css/custom.css')}}">
    <link href="{{ asset('memnon/custom.css') }}" rel="stylesheet">
