...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'MemnonTravel'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('MemnonTravel by')}} <a href="{{__('https://www.memnontravel.com')}}" target="_blank">{{__('SavvyHost Team')}}</a>
                    </div>
                    <div class="col-md-6">
