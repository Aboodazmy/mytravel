<?php if($list_item): ?>
    <div class="bravo-featured-item <?php echo e($style ?? ''); ?>">
        <div class="container text-center space-top-lg-2">
            ...
            <div class="swiper swiper-featured w-100 flex swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden">
                <div class="swiper-wrapper w-100">
                    <?php $__currentLoopData = $list_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="swiper-slide d-flex flex-column align-self-start">
...
<?php endif; ?>
<?php /**PATH C:\Users\m\Desktop\MyTravel\themes/Mytravel/Template/Views/frontend/blocks/list-featured-item/style_1.blade.php ENDPATH**/ ?>