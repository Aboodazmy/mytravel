...
<head>
    ...
    <title><?php echo e($page_title ?? 'Dashboard'); ?> - <?php echo e(setting_item('site_title') ?? 'MemnonTravel'); ?></title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        <?php echo e(date('Y')); ?> &copy; <?php echo e(__('MemnonTravel by')); ?> <a href="<?php echo e(__('https://www.memnontravel.com')); ?>" target="_blank"><?php echo e(__('SavvyHost Team')); ?></a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                        Powered By <a href="https://savvyhost.io">SavvyHost</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\Users\m\Desktop\MyTravel\modules/Layout/admin/app.blade.php ENDPATH**/ ?>