...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace      = 'Plugins\PaymentPaymob\Controllers';
    protected $adminModuleNamespace = 'Plugins\PaymentPaymob\Admin';
    ...
    protected function mapAdminRoutes()
    {
        Route::middleware([
            'web',
            'dashboard'
        ])->namespace($this->adminModuleNamespace)->prefix('admin/module/PaymentPaymob')->group(__DIR__ . '/Routes/admin.php');
    }
